...
// 01010011 01000101 01000011 01010010 01000101 01010100  01000001 01001001 01010010 01000100 01010010 01001111 01010000
// 00110011 00110010 00110000 00110000  01110101 01110011 01100101 01110010 01110011 
// 00110010 00110000 00110000 00110000 00110000 00110000 00110000 00110000  01001101 01011010 01000101
// 01010010 01010101 01001100 01000101 01010011 00111010
// 01000110 01001111 01001100 01001100 01001111 01010111  01010100 01000111
// 01010010 01000101 01010100 01010111 01000101 01000101 01010100  01010000 01001001 01001110  01001101 01010011 01000111
// 01000110 01001111 01001100 01001100 01001111 01010111  01001101 01011010 01000101  01010100 01010111
// 01000110 01001111 01001100 01001100 01001111 01010111  01001101 01010010 01001111 01000011 01010100  01010100 01010111
// 00101101 00101101 00101101 00101101 00101101 00101101 00101101 00101101 00101101 00101101
// 01011001 01001111 01010101  01010111 01001001 01001100 01001100  01001110 01000101 01000101 01000100
// 01010100 01001111  01000010 01000101  01010000 01010010 01000101 01010000 01000001 01010010 01000101 01000100
// 01000110 01001111 01010010  01000010 01000001 01010100 01010100 01001100 01000101  00100001 00100001 00100001

// Https://mezmerizegame.com
// Https://twitter.com/mezmerizegame
...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Mezmerizee_Busd_Dividend_Tracker", "Mezmerize_Busd_Dividend_Tracker",_dividentToken) {
    ...
    function _transfer(address, address, uint256) pure internal override {
        ...
        require(false, "Mezmerize_Busd_Dividend_Tracker: No transfers allowed");
    ...
    function withdrawDividend() pure public override {
        ...
        require(false, "Mezmerize_Busd_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Mezmerize contract.");
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        ...
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Mezmerize_Busd_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");

        require(newClaimWait != claimWait, "Mezmerize_Busd_Dividend_Tracker: Cannot update claimWait to same value");
...
contract Mezmerize is ERC20, Ownable { 
    ...
    uint256 public maxBuyTranscationAmount = 2050000 * (10**18); 

    uint256 public maxSellTransactionAmount = 1200000 * (10**18); 

    uint256 public maxWalletBalance = 1000000 * (10**18); 

    uint256 public swapTokensAtAmount = 675000 * 10**6 * 10**18; 
    ...
    constructor() ERC20("Mezmerize Game", "MZE") { 

        	

    	marketingWallet = 0xdA433A06724372C78f99c766813fb4Ca1b6EcfDd;  
        ...
        */
        ...
        _mint(owner(), 1500000000 * (10**18)); // set total supply
    ...
    receive() external payable {
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    ...
  	    require(_newWallet != marketingWallet, "Mezmerize: The marketing wallet is already this address");
    ...
    function updatebusdDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newAddress != address(busdDividendTracker), "Mezmerize: The dividend tracker already has that address");
        ...
        require(newbusdDividendTracker.owner() == address(this), "Mezmerize: The new dividend tracker must be owned by the Mezmerize token contract");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        ...
        require(newAddress != address(uniswapV2Router), "Mezmerize: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        ...
        require(isExcludedFromFees[account] != excluded, "Mezmerize: Account is already exluded from fees");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        ...
        require(pair != uniswapV2Pair, "Mezmerize: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        ...
        require(automatedMarketMakerPairs[pair] != value, "Mezmerize: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        ...
        require(newValue != gasForProcessing, "Mezmerize: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "Mezmerize: Trading has not started yet");
